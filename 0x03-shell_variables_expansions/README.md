...
16 - Write a script that prints every other line from the input.

17 - Write a shell script that adds the two numbers stored in the environment variables WATER and STIR.
